...
angular.module('biffyApp')
    .controller('EmployeesPermissionsController', function($q, $scope, $stateParams, $state, RestangularAppService, NotifierService) {
        ...
        $q.all([
            ...
            RestangularAppService.one('users', $scope.id).getList('permissions', {store_only: true})
        ...
        $scope.update = function() {
            RestangularAppService.one('users', $scope.id).post('permissions', {permissions: $scope.userPermissions, store_only: true}).then(function() {
