...
/**
 * Class VerifyNotOnBreakCommandHandler
 * @package Biffy\Commands\TimeClock
 */
class VerifyNotOnBreakCommandHandler implements CommandHandler
{
    /**
    ...
    public function handle(AbstractCommand $command)
    {
        if ($this->timeClockRepository->isUserOnBreak($command->store_id, $command->user_id)) {
            throw new CommandFailedException('timeclock_err_user_on_break');
        }
    }
