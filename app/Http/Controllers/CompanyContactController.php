...
use Biffy\Services\Entities\CompanyContact\CompanyContactService;
...
class CompanyContactController extends ApiController
{
    ...
    /**
     * @param CompanyContactService $service
     */
    function __construct(CompanyContactService $service)
    {
    ...
    public function index($companyId)
    {
       //@todo Make new config setting for count per page
        ...
        $filter = is_null($filter) ? [ 'company_id' => $companyId ] : array_merge($filter, [ 'company_id' => $companyId ]);
